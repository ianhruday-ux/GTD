...
function injectChunkMap(){
  ...
  ["gtd_chunk_map_v1", "gtd_chunk_map_v2", "gtd_chunk_map_v3", "gtd_chunk_map_v4",
   ...
   "gtd_chunk_map_v12", "gtd_chunk_map_v13"].forEach(Storage.remove);  // retire superseded flags
